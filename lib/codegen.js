...
var defaultSuccessfulResponseType =  { description: 'any',isAtomic:true, isEnum: false,tsType: 'any' };
...
var getViewForSwagger2 = function(opts, type){
    ...
    _.forEach(swagger.paths, function(api, path){
        ...
        _.forEach(api, function(op, m){
            ...
            try {
                successfulResponseType = ts.convertType(op.responses['200']) || defaultSuccessfulResponseType;
            } catch (error) {
